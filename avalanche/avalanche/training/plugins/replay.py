...
from avalanche.benchmarks.utils.data_loader import ReplayDataLoader,ReplayDetDataLoader
...
class ReplayPlugin(SupervisedPlugin):
    ...
    def before_training_exp(self, strategy: "SupervisedTemplate",
        ...
        strategy.dataloader = ReplayDataLoader(
            ...
            batch_size_mem=batch_size_mem//2,
...
class ReplayDetPlugin(SupervisedPlugin):
    """
    Experience replay plugin.
    ...
    def __init__(self, mem_size: int = 200, batch_size: int = None,
        ...
        self.mem_size = mem_size
        self.batch_size = batch_size
        self.batch_size_mem = 2#batch_size_mem
        self.task_balanced_dataloader = task_balanced_dataloader
    ...
    def before_training_exp(self, strategy: "SupervisedTemplate",
        ...
        strategy.dataloader = ReplayDetDataLoader(
            strategy.adapted_dataset,
            self.storage_policy.buffer,
            oversample_small_tasks=True,
